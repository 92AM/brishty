...
const TopLocationsWeatherPreviewsCarousel = ({
  items,
  mainLocation,
}: TopLocationsWeatherPreviewsCarouselProps) => {
  const topForecasts: any = [];
  items.forEach((locationWeather) => {
    const location =
      locationWeather.locationName + ', ' + locationWeather.countryCode;
    topForecasts.push(
        ...
        >
          ...
          <div className="items-center">
            <a className="flex space-x-4" href={'/weather/' + location}>
              <p className="flex-1 text-gray-800 text-lg hover:underline">
                View Weather
              </p>
              <svg
      ...
      >
        ...
        >
          <div className="flex-1">
            <span className="block pt-16 text-center text-3xl text-gray-800">
              View More
            </span>
          </div>
          <svg
