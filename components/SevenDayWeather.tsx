            ...
            <div className="grid gap-4 grid-cols-2">
              <div className="divide-y space-y-2">
                <div>
                  ...
                  <p className="text-center">
                    <b>
                      {Math.round(
                        Number(eachDay.probabilityOfPrecipitation) * 100
                      )}
                      %
                    </b>
                  </p>
                ...
                <div>
                  ...
                  <p className="text-center">
                    <b>
                      {`${windDegreeToText(
                        Number(eachDay.windDegree)
                      )} ${Math.round(Number(eachDay.windSpeed))} km/hr`}
                    </b>
                  </p>
                </div>
                <div>
              ...
              <div className="divide-y space-y-2">
                <div>
                  ...
                  <p className="text-center">
                    <b>
                      {moment.unix(Number(eachDay.sunrise)).format('HH:MM')}
                    </b>
                  </p>
                </div>
                <div>
  ...
  return (
    <div className="md:flex">
      <div className="flex overflow-x-scroll hide-scroll-bar h-full">
        <div className="flex flex-nowrap py-2">{slideComponents}</div>
      </div>
    </div>
  );
};
