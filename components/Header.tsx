...
const Header = () => {
  ...
  const checkIfSearchContentIsClicked = (e: any) => {
    if (
      ...
      searchContentNode.current.contains(e.target)
    ) {
      ...
      <div className="relative w-full z-10 fixed top-0 bg-gray-800 border-b border-grey-light">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-4">
          <div className="pl-4 flex items-center">
            ...
            {/*</svg>*/}
            <a
              className="text-white text-base no-underline hover:no-underline font-extrabold text-xl"
              href="/"
            >
              {' '}
              Brishty
