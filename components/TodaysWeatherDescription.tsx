  ...
  return (
    <div className="px-4 2xl:px-32">
      ...
      <div className="text-gray-800 text-lg text-left p-2">
        Expect {weatherDetails.current.weather.description} today, currently the
      ...
      <div className="text-gray-800 text-lg text-left p-2">
        If you would like to know a bit more about the various weather icons
        used on this site, please feel free to look at the icons page where we
        have outlined the meaning of each icon.
      </div>

      <div className="text-blue-900 text-lg text-left p-2 hover:underline">
        <Link href={'/icons'}>
          {'Find out more about weather icons here >'}
        </Link>
      </div>
    </div>
  );
