...
const PageContentWrapper = ({children, classNameCustomAttributes, addDefaultAttributes}: Props) => {
    ...
    const defaultClassNameAttributes = addDefaultAttributes ? "md:container md:mx-auto" : "";
    const defaultClassNameAttributesToAdd = addDefaultAttributes ? (defaultClassNameAttributes + " px-4 pt-20 pb-4") : "";
