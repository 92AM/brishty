...
const mapLocationDetailsJsonToLocationCurrentWeather = (
  locationDetailsJson: any
): LocationCurrentWeather => {
  const imageLink =
    '/images/' +
...
const mapNearbyLocationsJsonToNearbyLocations = (
  nearbyLocationsJson: any
): NearbyLocation[] => {
...
export const getWeatherDetailsByLocationName = async (
  ...
  const nearbyLocationsWithSourceRemoved =
    removeSourceLocationFromNearbyLocation(nearbyLocations, locationName);
...
export const getUkTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  ...
  for (const locationName of topUkStaticLocationSearchTerms) {
    ukTopLocationsCurrentWeathers.push(
      await getLocationCurrentWeather(locationName)
    );
  }
  return ukTopLocationsCurrentWeathers;
};

export const getUkMoreTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
...
export const getEuropeTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  const topEuropeStaticLocationSearchTerms =
    getStaticEuropeanTopSearchLocations();
  const europeTopLocationsCurrentWeathers = [];

  for (const locationName of topEuropeStaticLocationSearchTerms) {
    europeTopLocationsCurrentWeathers.push(
      await getLocationCurrentWeather(locationName)
    );
  }
...
export const getEuropeMoreTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  const topEuropeStaticLocationSearchTerms =
    getMoreStaticEuropeanTopSearchLocations();
...
export const getWorldTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  const topWorldStaticLocationSearchTerms =
    getStaticRestOfWorldTopSearchLocations();
  const worldTopLocationsCurrentWeathers = [];

  for (const locationName of topWorldStaticLocationSearchTerms) {
    worldTopLocationsCurrentWeathers.push(
      await getLocationCurrentWeather(locationName)
    );
  }
...
export const getWorldMoreTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  const topWorldStaticLocationSearchTerms =
    getMoreStaticWorldTopSearchLocations();
...
export const getAsiaTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  ...
  for (const locationName of topAsianStaticLocationSearchTerms) {
    asianTopLocationsCurrentWeathers.push(
      await getLocationCurrentWeather(locationName)
    );
  }
...
export const getAsiaMoreTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  const topAsianStaticLocationSearchTerms =
    getMoreStaticAsianTopSearchLocations();
  const asianTopLocationsCurrentWeathers = [];
...
export const getAmericasTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  const topAmericasStaticLocationSearchTerms =
    getStaticAmericasTopSearchLocations();
  const americasTopLocationsCurrentWeathers = [];

  for (const locationName of topAmericasStaticLocationSearchTerms) {
    americasTopLocationsCurrentWeathers.push(
      await getLocationCurrentWeather(locationName)
    );
  }
...
export const getAmericasMoreTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  const topAmericasStaticLocationSearchTerms =
    getMoreStaticAmericasTopSearchLocations();
...
export const getAfricaTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  const topAfricaStaticLocationSearchTerms =
    getStaticAfricaTopSearchLocations();
  const africaTopLocationsCurrentWeathers = [];

  for (const locationName of topAfricaStaticLocationSearchTerms) {
    africaTopLocationsCurrentWeathers.push(
      await getLocationCurrentWeather(locationName)
    );
  }
...
export const getAfricaMoreTopLocationsCurrentWeathers = async (): Promise<
  LocationCurrentWeather[]
> => {
  const topAfricaStaticLocationSearchTerms =
    getMoreStaticAfricaTopSearchLocations();
