...
import { WORLD_NEW_CLIENT_RESPONSE_MOCK, WORLD_NEWS_PARSED_MOCK } from '../../test-support/Stubs';
...
describe('WorldNewsService', () => {
    it('should get world news', async () => {
        nyTimesNewsClientMock.mockResolvedValue(WORLD_NEW_CLIENT_RESPONSE_MOCK);
