...
export default function About() {
  return (
    <Layout title="Brishty - search for weather">
      <PageContentWrapper
        classNameCustomAttributes={'px-4 pt-20 pb-5 min-h-screen'}
      >
        <div className="grid grid-cols-1 gap-4 container mx-auto">
          ...
          <div className="py-3 text-xl">
            <p className="py-3">
              ...
              weather. Brishty provides weather forecasts to help people with
              those decisions so that they can be safe and create plans
              successfully.
            </p>
          ...
          <p className="py-3 text-xl">
            Please feel free to send us questions and feedbacks by completing
            the below form.
          </p>
          <form
          ...
          <span className="pt-6 pb-6 text-2xl">
            Here are few suggestions that you may find useful.
          </span>
          ...
          >
            <div className="flex space-x-2">
              ...
              <div className="flex-1">
                <p className="pt-1 text-lg text-gray-700 text-base">
                  Home page
                </p>
              </div>
